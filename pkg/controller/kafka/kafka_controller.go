...
import (
	...
	dbv1 "github.com/hrshtiwari/kafka-operator/pkg/apis/db/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &dbv1.Kafka{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *dbv1.Kafka) *corev1.Pod {
